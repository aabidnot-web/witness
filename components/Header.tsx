...
function getHeaderMetrics(viewportWidth: number) {
  if (viewportWidth <= 640) {
    return {
      ...
      blurExpanded: 8, blurCompact: 15,
      bgExpanded: 0.14, bgCompact: 0.24,
      borderExpanded: 0.12, borderCompact: 0.18,
      shadowExpanded: 0.16, shadowCompact: 0.24,
      shadowYExpanded: 14, shadowYCompact: 20,
      shadowBlurExpanded: 34, shadowBlurCompact: 48,
      brandExpanded: 22, brandCompact: 20,
  ...
  if (viewportWidth <= 960) {
    return {
      ...
      blurExpanded: 8, blurCompact: 16,
      bgExpanded: 0.13, bgCompact: 0.24,
      borderExpanded: 0.12, borderCompact: 0.18,
      shadowExpanded: 0.16, shadowCompact: 0.24,
      shadowYExpanded: 14, shadowYCompact: 20,
      shadowBlurExpanded: 34, shadowBlurCompact: 48,
      brandExpanded: 23, brandCompact: 21,
      liftExpanded: 0, liftCompact: -1,
      highlightExpanded: 0.08, highlightCompact: 0.11,
      saturateExpanded: 132, saturateCompact: 148,
      sheenExpanded: 0.07, sheenCompact: 0.12,
  ...
  return {
    ...
    blurExpanded: 8, blurCompact: 18,
    bgExpanded: 0.12, bgCompact: 0.24,
    borderExpanded: 0.1, borderCompact: 0.17,
    shadowExpanded: 0.14, shadowCompact: 0.24,
    shadowYExpanded: 14, shadowYCompact: 22,
    shadowBlurExpanded: 34, shadowBlurCompact: 52,
    brandExpanded: 24, brandCompact: 22,
...
export default function Header() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const transitionStart = Math.max(36, heroHeight * 0.16);
      const transitionEnd = Math.max(transitionStart + 1, heroHeight * 0.68);
